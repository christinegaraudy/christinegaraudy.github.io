...
//if the hour is a number from 0 and 11 inclusive, log good morning
if (hour > -1 && hour < 12) { 
    console.log('Good Morning!');
//if the hour is a number from 12 and 16 inclusive, log good afternoon    
} else if (hour > 11 && hour < 17){
    console.log('Good Afternoon!');
//if the hour is a number from 17 to 21 inclusive, log good evening    
} else if (hour > 16 && hour < 22) {
    console.log('Good Evening!');
//default if none of the above, log good night  
} else {
